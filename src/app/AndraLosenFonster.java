 ...
 */
public class AndraLosenFonster extends javax.swing.JFrame {

    /**
     * Creates new form AndraLosenFonster
     */
    public AndraLosenFonster() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        andraLosenRubrik = new javax.swing.JLabel();
        nyttLosenField = new javax.swing.JTextField();
        losenField = new javax.swing.JTextField();
        nyttLosenRubrik = new javax.swing.JLabel();
        losenRubrik = new javax.swing.JLabel();
        bAndra = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        andraLosenRubrik.setText("Ändra lösenord:");

        nyttLosenField.setColumns(8);

        losenField.setColumns(8);
        ...
        losenRubrik.setText("Lösenord:");

        bAndra.setText("Ändra lösenord");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AndraLosenFonster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AndraLosenFonster().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel andraLosenRubrik;
    private javax.swing.JButton bAndra;
    private javax.swing.JTextField losenField;
    private javax.swing.JLabel losenRubrik;
